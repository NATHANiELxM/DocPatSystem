...
namespace DocPatSystem
{
    public partial class myRecords : UserControl
    {
        ...
        {
            Pat.grantAccess newGrantAccessPage = new Pat.grantAccess();
            newGrantAccessPage.FormClosed += new FormClosedEventHandler(newGrantAccessPageClosed);
            newGrantAccessPage.Show();
            this.Hide();
        }
        void newGrantAccessPageClosed(object sender, FormClosedEventArgs e)
        {
            this.Show();
        }
        //Textboxes
