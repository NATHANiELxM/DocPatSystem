...
{
    public partial class incomingScrips : UserControl
    {
        private BindingSource bindingSource1 = new BindingSource();

        public incomingScrips()
        {
            InitializeComponent();
        }

        private void incomingScrips_Load(object sender, EventArgs e)
        {
            ...
            GetData("select * from crn_prescription where status = 'NEW'");
        }
