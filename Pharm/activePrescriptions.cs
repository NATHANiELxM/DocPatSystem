...
{
    public partial class activePrescriptions : UserControl
    {
        ...
        private void activeScripsPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            GetData("select * from crn_prescription where status != 'GOT'");
        }
